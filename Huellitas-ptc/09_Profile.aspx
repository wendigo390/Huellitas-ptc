<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="09_Profile.aspx.cs" Inherits="Huellitas_ptc._09_Profile" %>
                    ...
                    <nav aria-label="breadcrumb" class="main-breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a style="color: #000;" class="navbar-brand" href="Index.aspx">
                                    <img src="1/pata1.png" height="40" width="40" />Home
                                </a>
                            </li>
                        </ol>
                    </nav>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        ...
                                        <div class="mt-3">
                                            <span style="font-size: 24px;"><%= Session["usuario"] %></span>
