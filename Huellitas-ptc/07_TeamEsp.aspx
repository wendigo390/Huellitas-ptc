<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="07_TeamEsp.aspx.cs" Inherits="Huellitas_ptc._07_TeamEsp" %>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
				<li class="nav-item "><a href="IndexEsp.aspx" class="nav-link">Inicio</a></li>
	        	...
	        	<li class="nav-item"><a href="06_ShopEsp.aspx" class="nav-link">Tienda</a></li>
                 <li class="nav-item active"><a href="07_TeamEsp.aspx" class="nav-link">Equipo</a></li>
