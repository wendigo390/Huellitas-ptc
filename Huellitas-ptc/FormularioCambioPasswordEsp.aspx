<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormularioCambioPasswordEsp.aspx.cs" Inherits="Huellitas_ptc.FormularioCambioPasswordEsp" %>
                            ...
                            <div class="card-body px-lg-5 py-lg-5">
                                ...
                                <div class="form-group mb-3">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <asp:TextBox ID="txtpassword1" runat="server" placeholder="Contraseña " class="form-control" minlength="3" MaxLength="200" Width="310px" ></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                   <div class="input-group input-group-alternative">
                          <asp:TextBox ID="txtpassword2" runat="server" placeholder="Repita la Contraseña " class="form-control" minlength="3" MaxLength="200" Width="310px"></asp:TextBox><div class="input-group input-group-alternative">
                           </div>      
                          </div>
                                  <br />
